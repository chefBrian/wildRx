...
import { listSpecies } from '../../firebase/repos';
  ...
  return (
    <main className="mx-auto max-w-md px-5 pt-12 pb-12">
      <header className="space-y-2">
        <div className="text-[11px] uppercase tracking-[0.14em] text-ink2">Step 2 of 3 · Patient</div>
      ...
      <div className="mt-10 space-y-10">
        ...
        <div>
          <label htmlFor="weight" className="block text-[11px] uppercase tracking-[0.14em] text-ink2 mb-2">
            Weight <span className="lowercase tracking-normal italic text-ink2/80">(grams)</span>
          </label>
          <input
            id="weight"
            type="number"
